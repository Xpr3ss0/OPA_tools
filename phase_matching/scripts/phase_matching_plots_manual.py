...
if __name__ == "__main__":
    ...
    lmd_s_array = np.linspace(signal_range[0], signal_range[1], 200)
    ...
    for alpha_deg in alpha_values:
        ...
        for i, lmd_s in enumerate(lmd_s_array):
            gain_array[i] = OPA_gain(theta=np.radians(theta_value), lmd_s=lmd_s, alpha=np.radians(alpha_deg), L=L, I_p=I_p, 
